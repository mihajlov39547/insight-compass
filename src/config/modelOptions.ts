...
export const modelOptions: ModelOption[] = [
  ...
  { id: 'openai/gpt-5.4-nano', name: 'gpt-5.4-nano', description: 'Premium-only. Fastest, cheapest GPT-5.4 — high-volume, latency-sensitive tasks.', provider: 'OpenAI', capabilities: ['Thinking'] },
  { id: 'openai/gpt-5.4-mini', name: 'gpt-5.4-mini', description: 'Premium-only. Balanced GPT-5.4 — strong reasoning at lower cost.', provider: 'OpenAI', capabilities: ['Thinking'] },
  { id: 'openai/gpt-5.4', name: 'gpt-5.4', description: 'Premium-only. Advanced reasoning, complex code generation, and analysis.', provider: 'OpenAI', capabilities: ['Thinking'] },
  { id: 'openai/gpt-5.4-pro', name: 'gpt-5.4-pro', description: 'Premium-only. Extended reasoning variant of GPT-5.4 for the hardest problems.', provider: 'OpenAI', capabilities: ['Thinking'] },
  { id: 'openai/gpt-5.5', name: 'gpt-5.5', description: 'Premium-only. State-of-the-art reasoning, coding, and instruction following.', provider: 'OpenAI', capabilities: ['Thinking'] },
  { id: 'openai/gpt-5.5-pro', name: 'gpt-5.5-pro', description: 'Premium-only. Premium GPT-5.5 with extended reasoning for the most demanding tasks.', provider: 'OpenAI', capabilities: ['Thinking'] },
