...
export const PLAN_LIMITS: Record<Plan, PlanLimits> = {
  ...
  basic: {
    ...
    canShareNotebooks: false,
    maxShareMembers: 3,
    restrictedModelIds: ['openai/gpt-5', 'openai/gpt-5.2', 'openai/gpt-5.4', 'openai/gpt-5.4-mini', 'openai/gpt-5.4-nano', 'openai/gpt-5.4-pro', 'openai/gpt-5.5', 'openai/gpt-5.5-pro'],
