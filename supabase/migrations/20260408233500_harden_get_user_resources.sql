...
AS $$
  SELECT
    ...
    -- Legacy alias kept for compatibility with existing frontend code.
...
COMMENT ON FUNCTION public.get_user_resources()
IS 'Unified resource projection. Classification is canonical in backend. is_shared is a legacy alias for is_shared_with_me.';
