    ...
    const context = {
      ...
      permapeopleProfile: permaRow
        ? {
            ...
            edibleUses: permaNorm?.edibleUses ?? null,
            lifeCycle: permaNorm?.lifeCycle ?? null,
            daysToHarvest: permaNorm?.daysToHarvest ?? null,
            propagationMethod: permaNorm?.propagationMethod ?? null,
            soilPh: permaNorm?.soilPh ?? null,
            spacing: permaNorm?.spacing ?? null,
            utility: permaNorm?.utility ?? null,
            nativeTo: permaNorm?.nativeTo ?? null,
